...
st.set_page_config(page_title="AirBnb-Analysis by Vandhitha!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
     ...
     if fl is not None:
         ...
         df = pd.read_csv(r"C:\Users\VANDHITHA\Downloads\Airbnb NYC 2019.csv", encoding="ISO-8859-1")
